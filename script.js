{
    ...
    searchInput.addEventListener("input", (e) => {
        ...
        pokemonNames.forEach((pokemonName) => {
            if (pokemonName.innerHTML.toUpperCase().includes(searchValue)) {
    ...
    <div class="poke-info">
        ...
        <h3 class="poke-name">${pokemon.species.name.toUpperCase()}</h3>
        <div class="small">
            <small class="poke-exp"><i class="fa solid fa-flask">${pokemon.base_experience} xp</i></small>
            <small class="poke-weight"><i class="fa solid fa-flask"></i>${pokemon.weight}kg</small>
        </div>
        <div class="poke-type"><i class="fa-brands fa-uncharted"></i>  ${pokemonType.toUpperCase()}
        </div>
    </div>
    `
